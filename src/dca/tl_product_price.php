...
/**
 * Table tl_product_price
 */
$GLOBALS['TL_DCA']['tl_product_price'] = array
(
	...
	(
		'dataContainer'               => 'Table',
		'ptable'                      => 'tl_product_price_category',
	...
	(
		...
		(
			...
			'child_record_callback'   => array('tl_product_price', 'listPrices'),
		),
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_product_price']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_product_price']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_product_price']['toggle'],
				'icon'                => 'visible.gif',
				'attributes'          => 'onclick="Backend.getScrollOffset();return AjaxRequest.toggleVisibility(this,%s)"',
				'button_callback'     => array('tl_product_price', 'toggleIcon')
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_product_price']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
	...
	(
		...
		'price' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_product_price']['price'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'date' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_product_price']['date'],
			'default'                 => time(),
			'exclude'                 => true,
			'filter'                  => true,
			'sorting'                 => true,
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_product_price']['published'],
			'exclude'                 => true,
			'filter'                  => true,
			'flag'                    => 1,
			'inputType'               => 'checkbox',
 ...
 */
class tl_product_price extends Backend
{
	...
	public function toggleVisibility($intId, $blnVisible, DataContainer $dc=null)
	{
		...
		// Update the database
		$this->Database->prepare("UPDATE tl_product_price SET tstamp=". time() .", published='" . ($blnVisible ? 1 : '') . "' WHERE id=?")
					   ->execute($intId);
