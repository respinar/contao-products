...
(
	'catalog' => array
	(
		'tables'     => array('tl_catalog','tl_catalog_category','tl_catalog_product','tl_catalog_type'),
		'icon'       => 'system/modules/catalog/assets/icon.png',
		//'stylesheet' => 'system/modules/carpets/assets/backend.css'
	)
));
...
(
	'catalog' => array
	(
        'catalog_menu'    => 'ModuleCatalogMenu',
		'catalog_list'    => 'ModuleCatalogList',
		'catalog_product' => 'ModuleCatalogProduct',
