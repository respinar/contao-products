 ...
 */
 ...
 $GLOBALS['TL_MODELS']['tl_product']         = 'Respinar\ProductsBundle\Model\ProductModel';
 $GLOBALS['TL_MODELS']['tl_product_catalog'] = 'Respinar\ProductsBundle\Model\ProductCatalogModel'; 
 //$GLOBALS['TL_MODELS']['tl_product_price']   = 'Respinar\ProductsBundle\Model\ProductPriceModel'; 
 ...
 */
//$GLOBALS['TL_HOOKS']['getSearchablePages'][] = array('Respinar\ProductsBundle\Product', 'getSearchablePages');


// Registrieren im Hooks replaceInsertTags
//$GLOBALS['TL_HOOKS']['replaceInsertTags'][] = array('Respinar\ProductsBundle\Product', 'productURLInsertTags');
