 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_catalog_product']['title']       = array('عنوان کالا', 'Please enter the product title.');
...
$GLOBALS['TL_LANG']['tl_catalog_product']['languageMain']= array('کالای اصلی', 'Choose the product in the master category equaling this product.');
$GLOBALS['TL_LANG']['tl_catalog_product']['related']     = array('کالاهای مرتبط', 'Choose related products in this category to this product.');
 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_catalog_product']['new']    = array('کالای جدید', 'Create a new product');
$GLOBALS['TL_LANG']['tl_catalog_product']['show']   = array('جزئیات کالا', 'Show the details of product ID %s');
$GLOBALS['TL_LANG']['tl_catalog_product']['edit']   = array('ویرایش کالا', 'Edit product ID %s');
$GLOBALS['TL_LANG']['tl_catalog_product']['cut']    = array('جابجایی کالا', 'Move product ID %s');
$GLOBALS['TL_LANG']['tl_catalog_product']['copy']   = array('تکثیر کالا', 'Duplicate product ID %s');
$GLOBALS['TL_LANG']['tl_catalog_product']['delete'] = array('حذف کالا', 'Delete product ID %s');
